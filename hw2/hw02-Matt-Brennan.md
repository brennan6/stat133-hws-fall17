...
![](hw02-Matt-Brennan_files/figure-markdown_github-ascii_identifiers/unnamed-chunk-6-1.png) Display the Player name, team, salary, and Eff value of the top ten players by EFF in decreasing order.
...
![](hw02-Matt-Brennan_files/figure-markdown_github-ascii_identifiers/unnamed-chunk-10-1.png) 5) Efficiency and Salary Create a scatterplot between EFF and Salary
...
![](hw02-Matt-Brennan_files/figure-markdown_github-ascii_identifiers/unnamed-chunk-11-1.png) Correlation between EFF and Salary
...
![](hw02-Matt-Brennan_files/figure-markdown_github-ascii_identifiers/unnamed-chunk-14-1.png) Compute the linear correlation coefficient between player2, salary and efficiency.
...
1.  Comments and Reflection
2.  Utilizing the readr information was very difficult for me.
3.  Utilizing the certain functions of slice and select.
4.  I needed to talk out a couple of the problems with friends for a better understanding
5.  5 hours
6.  The Readr part.
7.  The other version of the lowess line.
8.  Readr attributes.
9.  Question 4 and 5
